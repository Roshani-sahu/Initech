  ...
  return (
    <section className=" py-20 bg-white px-6 lg:px-24">
      <div className="max-w-8xl mx-auto">
        ...
        {/* Description */}
        <p className="mb-16 text-lg leading-relaxed text-[#0A0A0A] max-w-3xl">
          Initech bridges the gap between innovation and reliability. Our edge-native platform
          is designed to keep your systems running seamlessly — even when networks fail.
          We bring intelligence, autonomy, and resilience to your connected world.
        </p>

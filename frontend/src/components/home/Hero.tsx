      ...
      <div className="relative max-w-full mx-auto">
        ...
        <div className="mb-16">
          ...
          <h2 className="md:mb-8 text-5xl font-light font-Kairos  text-[#0A0A0A66] sm:text-6xl lg:text-[100px]">
            Servers & Cloud
            <br />
            <div className="flex md:flex-row flex-col gap-4"> <span> Optional. </span> <div className="max-w-md mb-12 text-lg mt-5  text-black font-extralight">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <button className="px-6 py-2 md:py-3 text-base font-medium text-gray-900 transition-colors border border-gray-200 rounded-xl hover:bg-gray-200 hover:text-gray-700">
              SCHEDULE A DEMO
            </button>
          </div>
        </div>

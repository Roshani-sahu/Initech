...
function TechSection() {
  return (
    <section className="px-8 py-20 mx-auto max-w-7xl">
      {/* Header */}
      <div className="mb-16">
        <h1 className="mb-6 text-5xl font-bold text-black">The Tech</h1>
      ...
      <div className="grid items-start grid-cols-2 gap-12">
        ...
        <div className="space-y-12">
          ...
          <div>
            <p className="mb-6 text-xs font-semibold tracking-widest text-gray-600">FOUNDATIONAL TECHNOLOGY</p>
            ...
            <div>
              <h3 className="mb-4 text-2xl font-semibold text-gray-400">CRDT-powered conflict resolution</h3>
